    ...
    def predict(self,que_pair, sub_graph,T_id, test_graph, num_rels, static_graph, test_triplets, use_cuda):
        with torch.no_grad():
            ...
            if self.pre_type == "all":
                ...
                scores_ob, query_vec = self.decoder_ob.forward( embedding,r_emb, all_triples,  his_emb, self.pre_weight, self.pre_type)
                self._last_query_embeddings = query_vec.detach()
